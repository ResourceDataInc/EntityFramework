...
{
    public class ExpressionPrintingVisitor : ExpressionVisitor
    {
        ...
        private readonly Action<IndentedStringBuilder, string> _append = (sb, s) => sb.Append(s);
        private readonly Action<IndentedStringBuilder, string> _appendLine = (sb, s) => sb.AppendLine(s);
        ...
        public ExpressionPrintingVisitor(IndentedStringBuilder stringBuilder, List<IConstantPrinter> constantPrinters)
        {
            _stringBuilder = stringBuilder;
            _constantPrinters = constantPrinters;
            _parametersInScope = new Dictionary<ParameterExpression, string>();
        }

        public bool TrackedQuery { get; private set; }
        ...
        protected override Expression VisitMemberInit(MemberInitExpression node)
        {
            ...
            var appendAction = node.Bindings.Count > 1 ? _appendLine : _append;
        ...
        protected override Expression VisitMethodCall(MethodCallExpression node)
        {
            ...
            var appendAction = simpleMethods.Contains(node.Method.Name) ? _append : _appendLine;
        ...
        protected override Expression VisitNew(NewExpression node)
        {
            ...
            var appendAction = node.Arguments.Count > 1 ? _appendLine : _append;
            appendAction(_stringBuilder, "(");
            _stringBuilder.IncrementIndent();
        ...
        {
            var appendAction = node.Expressions.Count > 1 ? _appendLine : _append;
